...
Check.part()
Check.equal("""multiply(3, 7)
""", "mmmm"
) and \ 
Check.equal("""multiply(6, 7)""", 42)
Check.equal("""multiply(10, 10)""", 100) and \ 
Check.equal("""multiply(11, 10)""", 110)
...
Check.equal("""x""", 4) and \ 
Check.equal("""c""", 5)
Check.equal("""x""", "lal2") and \ 
Check.equal("""c""", """lalallallalalalalalalalalallallaalalalalallalalalalalalalalalalalala2""")
